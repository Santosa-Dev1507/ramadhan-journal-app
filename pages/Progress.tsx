    ...
    const calculateGamification = async () => {
        ...
        const calculatedBadges: Badge[] = [
            { 
                ...
                icon: 'no_meals', 
                color: 'primary', 
                isUnlocked: totalFasting >= 5 // Unlocks after 5 days of fasting
            },
            { 
                id: '2', 
                ...
                icon: 'menu_book', 
                color: 'blue', 
                isUnlocked: history.filter(h => h.ibadahWajib.tilawah1Juz).length >= 3 
            },
            { 
                id: '3', 
                name: 'Dermawan', 
            ...
            { 
                ...
                }, 0) >= 15 // Need 15 total jamaah prayers to unlock
            },
            { 
                id: '5', 
                name: 'Khatam Quran', 
